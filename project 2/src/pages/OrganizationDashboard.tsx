    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">لوحة تحكم الجهات</h1>
            <p className="text-gray-600 mt-2">مراقبة شاملة وإدارة متقدمة للحملات والأراضي</p>
          </div>
        ...
        {selectedTab === 'monitoring' && (
          <div className="space-y-8">
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-6">نظام الرصد والتحذير المبكر</h2>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                  <h3 className="font-semibold text-red-900 mb-2">تنبيهات حرجة</h3>
                  <p className="text-2xl font-bold text-red-600">5</p>
                  <p className="text-sm text-red-700">تتطلب تدخل فوري</p>
                </div>
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <h3 className="font-semibold text-yellow-900 mb-2">تنبيهات متوسطة</h3>
                  <p className="text-2xl font-bold text-yellow-600">12</p>
                  <p className="text-sm text-yellow-700">مراقبة مستمرة</p>
                </div>
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <h3 className="font-semibold text-green-900 mb-2">مناطق مستقرة</h3>
                  <p className="text-2xl font-bold text-green-600">156</p>
                  <p className="text-sm text-green-700">حالة جيدة</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-lg p-4">
                  <div className="flex justify-between items-start">
                    <div>
                      <h4 className="font-semibold text-gray-900">حملة تشجير الرياض الكبرى</h4>
                      <p className="text-sm text-gray-600">245 متطوع مشارك من أصل 500</p>
                    </div>
                    <span className="bg-green-100 text-green-800 px-3 py-1 rounded-full text-xs">نشطة</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        {selectedTab === 'volunteers' && (
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-6">إدارة المتطوعين</h2>
            <div className="text-center py-12">
              <Users className="h-16 w-16 text-gray-400 mx-auto mb-4" />
              <p className="text-gray-600">قائمة المتطوعين وإحصائيات المشاركة</p>
            </div>
          </div>
        )}
